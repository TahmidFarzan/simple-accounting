...
class EmailSendForProjectContractCategory extends Mailable
{
    ...
    public $projectContractCategory = null;

    public function __construct($event,$envelope,$subject,ProjectContractCategory $projectContractCategory)
    {
        $this->event = $event;
        $this->subject = $subject;
        $this->envelope = $envelope;
        $this->projectContractCategory = $projectContractCategory;
    }
    ...
    {
        return new Content(
            view: 'internal user.project contract.category.email',
            with: [
                'projectContractCategory' => $this->projectContractCategory,
                'event' => $this->event,
            ],
        );
    }
