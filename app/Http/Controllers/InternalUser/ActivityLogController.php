...
class ActivityLogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $subjectTypes = array("All","User","Setting","User permission group","Oil and gas pump","Oil and gas pump product","Oil and gas pump inventory","Oil and gas pump supplier","Oil and gas pump purchase","Oil and gas pump sell");
    ...
    private function sendEmail($event,$subject,$activitLogs){
        ...
        $moduleSetting = $emailSendSetting["module"]["ActivityLog"];
