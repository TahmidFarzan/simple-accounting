...
return new class extends Migration
{
    public function up()
    {
        Schema::create('user_permission_group_has_user_permissions', function (Blueprint $table) {
            ...
            $table->foreign('user_permission_group_id',"user_permission_group_has_user_permissions_fk_2")->references('id')->on('user_permission_groups')->onDelete('cascade');
            $table->foreign('user_permission_id',"user_permission_group_has_user_permissions_fk_3")->references('id')->on('user_permissions')->onDelete('cascade');
            $table->timestamps();
        });
    }
