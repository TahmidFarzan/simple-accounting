        ...
        <div class="card-body text-dark">
            ...
            <div class="row mb-2">
                ...
                @if (Auth::user()->hasUserPermission(["ACLMP03"]) == true)
                    <div class="collapse mb-2" id="exportCollapseDiv">
                        <div class="card card-body">
                            <form class="p-3" id="activityLogExportForm" action="{{ route("activity.log.export") }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label col-form-label-sm">Subject type</label>
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label col-form-label-sm">Event</label>
                                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label col-form-label-sm">Causer</label>
                                            <div class="col-md-6">
                                                <select name="causer" class="form-control form-control-sm">
                                                    <option value="">Select a causer</option>
                                                    <option value="All">All</option>
                                                    @foreach ( $causers as $perCauser)
                                                        <option value="{{ $perCauser->slug }}">{{ ($perCauser->slug == Auth::user()->slug) ? "Me" : $perCauser->name }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label col-form-label-sm">Create at</label>
                                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label col-form-label-sm">Create at condition</label>
                                            <div class="col-md-6">
                                                <select name="created_at_condition" class="form-control form-control-sm">
                                                    @foreach ([""=>"Select a condition","="=>"Equal","<"=>"Less than",">"=>"Greater than","<="=>"Equal or less than",">="=>"Equal or greater than"] as $perFieldIndex => $perField)
                                                        <option value="{{ $perFieldIndex }}" {{ ($perFieldIndex=="EqualOrLessThan") ? "selected" : null }}>{{ $perField }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label col-form-label-sm">Format <i class="fa-solid fa-asterisk" style="font-size: 10px;!important"></i></label>
                                            <div class="col-md-6">
                                                <select name="format" class="form-control form-control-sm" required>
                                                    <option value="">Select a format</option>
                                                    @foreach (["xlsx" => "Excel 2007","xls" => "Excel 5","csv" => "CSV","tsv" => "TSV","ods" => "ODS"] as $perTypeIndex => $perTypeValue)
                                                        <option value="{{ $perTypeIndex }}" {{ ($perFieldIndex=="xlsx") ? "selected" : null }}>{{ $perTypeValue }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <button class="btn btn-sm btn-outline-primary" type="submit">Export</button>
                                </div>
                            </form>
                        </div>
                    </div>
