...
@section('authContentOne')
    @php
        ...
        if(old('user_permission') == null){
            $allSelectedUserPermissions = $userPermissionGroup->userPermissions()->orderBy("user_permission_id","asc")->pluck("slug")->toArray();
        }
        else{
    ...
    <div class="card border-dark mb-2">
        <div class="card-body text-dark">
            <form action="{{ route("user.permission.group.update",["slug" => $userPermissionGroup->slug]) }}" method="POST" id="editForm">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="nameInput" name="name" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ (old('name') == null) ? $userPermissionGroup->name : old('name') }}" placeholder="Ex: Hello" maxlength="100" required>
                                    @error('name')
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="codeInput" name="code" class="form-control form-control-sm @error('code') is-invalid @enderror" value="{{ (old('code') == null) ? $userPermissionGroup->code : old('code') }}" placeholder="Ex: hello" maxlength="100" required>
                                    @error('code')
                                        <span class="invalid-feedback" role="alert" style="display: block;">
                                            <strong>{{ $message }}</strong>
                                        </span>
