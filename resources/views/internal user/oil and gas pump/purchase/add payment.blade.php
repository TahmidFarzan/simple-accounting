                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <input id="amountInput" name="amount" type="number" class="form-control form-control-sm @error('amount') is-invalid @enderror" value="{{ (old('amount') == null) ? 0 : old('amount') }}" min="0" max="{{ $oilAndGasPumpPurchase->totalDueAmount() }}" step="00.01" required>
