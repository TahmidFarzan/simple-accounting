                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if (Auth::user()->hasUserPermission(["OAGPPUMP03"]) == true)
                                                        <a href="{{ route("oil.and.gas.pump.purchase.details",["oagpSlug" => $oilAndGasPump->slug, "puSlug" => $perOAGPPurchase->slug]) }}" class="btn btn-info btn-sm m-2"><i class="fa-solid fa-info"></i></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @empty
