...
@section('authContentOne')
    ...
    <div class="card border-dark mb-2">
        <div class="card-body text-dark">
            <form action="{{ route("oil.and.gas.pump.update",["slug" => $oilAndGasPump->slug]) }}" method="POST" id="updateForm">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input id="nameInput" name="name" type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ (old('name') == null) ? $oilAndGasPump->name : old('name') }}" placeholder="Ex: Hello" maxlength="200" required>
                                    @error('name')
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input id="codeInput" name="code" type="text" class="form-control form-control-sm @error('code') is-invalid @enderror" value="{{ (old('code') == null) ? $oilAndGasPump->code : old('code') }}" placeholder="Ex: Hello" maxlength="200" required>
                                    @error('code')
                                        <span class="invalid-feedback" role="alert" style="display: block;">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <textarea id="descriptionInput" name="description" class="form-control form-control-sm @error('description') is-invalid @enderror" placeholder="Ex: Hello">{{ (old('description') == null) ? $oilAndGasPump->description : old('description') }}</textarea>
