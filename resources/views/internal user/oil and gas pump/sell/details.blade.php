                                    ...
                                    <tbody>
                                        @foreach ($oilAndGasPumpSell->oagpSellItems as $oagpSellItemIndex => $oagpSellItem)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $oagpSellItem->oagpProduct->name }}
                                                    @if ($oagpSellItem->oagpProduct->type == "Oil")
                                                        {{ $setting["oagpSetting"]["oil_unit"] }}
                                                    @endif
                                                    @if ($oagpSellItem->oagpProduct->type == "Gas")
        ...
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <div class="btn-group" role="group">
                    @if ((Auth::user()->hasUserPermission(["OAGPPUMP04"]) == true) && ($oilAndGasPumpSell->status == "Due"))
                        <a href="{{ route("oil.and.gas.pump.sell.add.payment",["oagpSlug" => $oilAndGasPumpSell->oilAndGasPump->slug, "puSlug" => $oilAndGasPumpSell->slug]) }}" class="btn btn-secondary">Add payment</a>
                    @endif
                </div>
            </div>
        </div>
