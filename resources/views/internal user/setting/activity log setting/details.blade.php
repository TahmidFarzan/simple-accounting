            ...
            <div class="card-body">
                ...
                <div class="card-body text-dark">
                    <div class="d-flex justify-content-center">
                        <p>
                            <b>Showing {{ ($activitylogLimit < $activityLogSetting->activityLogs()->count() ) ? "last ".$activitylogLimit : "All" }} out of {{ $activityLogSetting->activityLogs()->count() }} activity log(s).</b>
                        </p>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class=" table table-sm table-bordered table-striped">
                            ...
                            <tbody>
                                @forelse ($activityLogSetting->modifiedActivityLogs($activitylogLimit) as $perIndex => $perActivityLogDatas)
                                    <tr>
                                        <td>{{ $perIndex + 1 }}</td>
