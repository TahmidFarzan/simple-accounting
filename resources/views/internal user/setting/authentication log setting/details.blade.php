                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <th>:</th>
                                            <td>
                                                {{ ($authenticationLogSetting->fields_with_values["send_email_notification"] == null) ? "Not added yet." : $authenticationLogSetting->fields_with_values["send_email_notification"] }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <th style="width: 1%!important;">:</th>
                                            <td>
                                                {{ ($authenticationLogSetting->fields_with_values["auto_delete_scheduler_frequency"] == null) ? "Not added yet." : $authenticationLogSetting->fields_with_values["auto_delete_scheduler_frequency"] }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
