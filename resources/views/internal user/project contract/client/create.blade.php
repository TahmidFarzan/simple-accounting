...
@section('authContentOne')
    ...
    <div class="card border-dark mb-2">
        <div class="card-body text-dark">
            <form action="{{ route("project.contract.client.save") }}" method="POST" id="createForm">
                @csrf
                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control form-control-sm @error('gender') is-invalid @enderror" id="genderInput" name="gender" required>
                                        ...
                                        @foreach (array("Male","Female","Other") as $perGender)
                                            <option value="{{ $perGender }}" {{ (old('gender')==$perGender) ? 'selected' : null }}>{{ $perGender }}</option>
                                        @endforeach
                                    </select>
                                    @error('gender')
                                        <span class="invalid-feedback" role="alert" style="display: block;">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <input type="email" id="emailInput" name="email" class="form-control form-control-sm @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Ex: hello@xx.com" maxlength="255">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert" style="display: block;">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <textarea id="addressInput" name="address" class="form-control form-control-sm @error('address') is-invalid @enderror" placeholder="Ex:Kaligonj,Jhenaidah">{{ old('address') }}</textarea>
                                    @error('address')
                                        <span class="invalid-feedback" role="alert" style="display: block;">
                                            <strong>{{ $message }}</strong>
                                        </span>
