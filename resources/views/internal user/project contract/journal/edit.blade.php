...
@section('authContentOne')
    ...
    @php
        $currentEntryOption = (old("entry_type") == null) ?  $projectContractJournal->entry_type : old("entry_type");
    @endphp

    <div class="card border-dark mb-2">
        <div class="card-body text-dark">
            <form action="{{ route("project.contract.journal.update",["pcSlug" => $projectContract->slug,"slug" => $projectContractJournal->slug]) }}" method="POST" id="editForm">
                @csrf
                @method("PATCH")
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <input id="nameInput" name="name" type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ (old('name') == null) ?  $projectContractJournal->name :  old('name') }}" placeholder="Ex: Hello" maxlength="200" required>
                                    @error('name')
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <input id="entryDateInput" name="entry_date" type="date" class="form-control form-control-sm @error('entry_date') is-invalid @enderror" value="{{ (old('entry_date') == null) ? date('Y-m-d',strtotime($projectContractJournal->entry_date)) : date('Y-m-d',strtotime(old('entry_date')))  }}" required>
                                    @error('entry_date')
                                        <span class="invalid-feedback" role="alert" style="display: block;">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <input id="amountInput" name="amount" type="number" class="form-control form-control-sm @error('amount') is-invalid @enderror" value="{{ (old('amount') == null) ?  $projectContractJournal->amount :  old('amount') }}" min="0" placeholder="Ex: 0.0" step="0.01" required>
                                    @error('amount')
                                        <span class="invalid-feedback" role="alert" style="display: block;">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <textarea id="descriptionInput" name="description" class="form-control form-control-sm @error('description') is-invalid @enderror" placeholder="Ex: Hello">{{ (old('description') == null) ?  $projectContractJournal->description :  old('description') }}</textarea>
