    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row mb-3">
                    <label for="nickName" class="col-md-4 col-form-label text-md-end">Nick Name</label>

                    <div class="col-md-6">
                        <input id="nickName" type="text" class="form-control @error('user_id') is-invalid @enderror" name="user_id" value="{{ old('user_id') }}" required autocomplete="user_id" autofocus maxlength="100">
